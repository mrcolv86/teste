    ...
    <Card className="h-full flex flex-col bg-card border border-border">
      ...
      <CardHeader className="pb-3">
        <div className="flex justify-between items-start gap-2">
          <CardTitle className="line-clamp-2 break-words text-lg font-semibold text-foreground">
            {product.name}
          </CardTitle>
        ...
        {product.description && (
          <CardDescription className="line-clamp-3 break-words text-sm text-muted-foreground">
            {product.description}
          </CardDescription>
        )}
      </CardHeader>
            ...
            <div className="flex gap-2">
              {product.ibu !== undefined && (
                <Badge variant="secondary" className="flex items-center gap-1">
                  ...
                  <span>IBU: {product.ibu.toFixed(0)}</span>
                </Badge>
              )}
          ...
          {getPairings().length > 0 && (
            <div>
              <div className="flex items-center gap-1 mb-2">
                ...
                <span className="text-sm font-medium text-foreground">{t('products.pairings')}:</span>
              </div>
